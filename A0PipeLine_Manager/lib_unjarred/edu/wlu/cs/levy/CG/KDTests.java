...
public class KDTests {
     ...
     * Added by RH
     */
    @Test public void testDeleteAndInsert() throws KDException {
        int dims = 3;
        KDTree<Object> kt = new KDTree<Object>(dims);
        double [] targ1 = makeSample(dims);
        double [] targ2 = makeSample(dims);
        double [] targ3 = makeSample(dims);
        String arg1 = "a";
        String arg2 = "b";
        String arg3 = "c";
        
        kt.insert(targ1, arg1);
        Assert.assertTrue(kt.size() == 1);
        kt.insert(targ2, arg2);
        Assert.assertTrue(kt.size() == 2);
        kt.delete(targ1);
        Assert.assertTrue(kt.size() == 1);
        kt.delete(targ2);
        Assert.assertTrue(kt.size() == 0);
        kt.insert(targ1, arg1);
        Assert.assertTrue(kt.size() == 1);
        kt.insert(targ2, arg2);
        Assert.assertTrue(kt.size() == 2);
