 ...
 */
class FileInfoLongOffsets implements Cloneable {
	 ...
	 */
	private static final int GRAY16_SIGNED = 1;
	...
	private static final int GRAY32_FLOAT = 4;
	...
	private static final int RGB_PLANAR = 7;

	/** 1-bit black and white. Import only. */
	private static final int BITMAP = 8;

	/** 32-bit interleaved ARGB. Import only. */
	private static final int ARGB = 9;
	...
	private int width;
	private int height;
	private long offset = 0; // Use getOffset() to read
	private int nImages;
	...
	public String toString() {
		return "name=" + fileName + ", dir=" + directory + ", url=" + url + ", width=" + width + ", height=" + height
				+ ", nImages=" + nImages + ", type=" + getType() + ", format=" + fileFormat + ", offset=" + getOffset()
				+ ", whiteZero=" + (whiteIsZero ? "t" : "f") + ", Intel=" + (intelByteOrder ? "t" : "f") + ", lutSize="
				+ lutSize + ", comp=" + compression + ", ranges="
				+ (displayRanges != null ? "" + displayRanges.length / 2 : "null") + ", samples=" + samplesPerPixel;
	}
