...
public class CQuantifyVolumeLibraryCall extends ExternalCallToLibrary implements SpecialDimPlugin {
	...
	public String operationName() {
		return "C helper for quantifying cell volume";
	}
	...
	public CQuantifyVolumeLibraryCall() {
		initializeParams();
	}

	@Override
	public String getCommandName() {
		return "protobuf_volume";
	}
