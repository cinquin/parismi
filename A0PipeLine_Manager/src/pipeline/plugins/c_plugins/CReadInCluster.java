...
public class CReadInCluster extends ExternalCallToLibrary implements SpecialDimPlugin {
	...
	public String operationName() {
		return "C helper for adding clustering info read from a binary object into a list of segmented cells";
	}
	...
	public String[] getInputLabels() {
		return new String[] { "Seeds", "Binary" };
	}
	...
	public CReadInCluster() {
		initializeParams();
	}

	@Override
	public String getCommandName() {
		return "dilan_cluster_color";
	}
