...
public class CUnaryOperationLibraryCall extends ExternalCallToLibrary {
	...
	private void initializeParams() {
		param1 =
				new ComboBoxParameterPrintValueAsString("Operation", "", new String[] { "e^-x" }, "e^-x", false,
						methodListener1);
		param2 = null;
	}
	...
	public String operationName() {
		return "C helper for unary operations";
	}
	...
	public CUnaryOperationLibraryCall() {
		initializeParams();
	}
