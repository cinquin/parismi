...
public class CReorderSeedIndexLibraryCall extends ExternalCallToLibrary implements SpecialDimPlugin {
	...
	public String operationName() {
		return "C helper for removing gaps in cell index in protobuf structure";
	}
	...
	public CReorderSeedIndexLibraryCall() {
		initializeParams();
	}

	@Override
	public String getCommandName() {
		return "reorder_protobuf_idx";
	}
