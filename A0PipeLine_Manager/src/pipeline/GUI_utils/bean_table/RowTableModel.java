...
// Small modifications by Olivier Cinquin
/**
...
public abstract class RowTableModel<T> extends AbstractTableModel {
	 ...
	 *
	 * @param columnNames
	 *            <code>List</code> containing the names
	 *            of the new columns
	 */
	 ...
	 *            of the new columns
	 */
	private RowTableModel(List<T> modelData, List<String> columnNames) {
	...
	void setDataAndColumnNames(List<T> modelData, List<String> columnNames) {
	 ...
	 */
	void setRowClass(Class<?> beanClass) {
		this.rowClass = beanClass;
	}
	 ...
	 * <code>setColumnClass</code> method.
	 ...
	 *         appropriate member in <code>columnNames</code>. If <code>columnNames</code> does not have an entry for
	 *         this index
	 ...
	 */
	public @Nullable T getRow(int row) {
	 ...
	 *            data of the row being added
	 */
	void insertRow(int row, T rowData) {
	 ...
	 */
	void insertRows(int row, List<T> rowList) {
	 ...
	 * After the move, the row that was at index <code>start</code> will be at index <code>to</code>.
	...
	/**
	 * Replace current model data without firing any change event.
	 * 
	 * @param newModelData
	 *            Cannot be null
	 */
	public void setRowsDontFireUpdate(List<T> newModelData) {
	 ...
	 * @exception IllegalArgumentException
	 *                when the Class of the row data
