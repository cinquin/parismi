...
public class PrincipalCurveAlgorithm {
	...
	final public void start(int randomSeed) throws InterruptedException {
		Initialize(randomSeed);
		Continue();
	}

	public synchronized void Continue() throws InterruptedException {
	...
	final public boolean InnerStep() {
		RepartitionVoronoiRegions();
		return OptimizeVertices();
	}

	public synchronized void OuterStep() throws InterruptedException {
	...
	private synchronized void RepartitionVoronoiRegions() {
