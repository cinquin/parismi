...
final public class LineObject extends LineAbstract implements Line {
	...
	private static Vektor GetIntersection(Line line1, Line line2) {
		...
		try {
			...
			if (processing_utilities.pcurves.Utilities.MyMath.equals(w, 0)) // parallel lines
				return null;
			double s = v / w;
	...
	public static void main(String args[]) {
		...
		double[] coords2 = { 1, 1, 1 };
		double[] coords3 = { 1, 1, 0 };
		Vektor v1 = new VektorDD(coords1);
		Vektor v2 = new VektorDD(coords2);
		Vektor v3 = new VektorDD(coords3);
		Line l1 = new LineObject(v1, v2);
		Line l2 = new LineObject(v1, v3);
		System.out.println(l1.Reflect(v3));
		System.out.println(LineObject.GetIntersection(l1, l2));
	}
