...
package processing_utilities.curvature.features;
...
public abstract class HessianEvalueProcessor implements GaussianGenerationCallback {
	...
	protected abstract float measureFromEvalues2D(float[] evalues);
	protected abstract float measureFromEvalues3D(float[] evalues);
