...
public class Point3d {
	...
	private Point3d(double /* dtype */x, double /* dtype */y, double /* dtype */z) {
		this.x = x;
		this.y = y;
		this.z = z;
	}
	...
	double /* dtype */scalar(Point3d other) {
		return x * other.x + y * other.y + z * other.z;
	}

	Point3d times(double /* dtype */factor) {
	...
	double /* dtype */distance2(Point3d other) {
	...
	public static Point3d average(Point3d[] list) {
		...
		for (Point3d element : list)
			result = result.plus(element);
		return result.times(1.0 / list.length);
	}

	static Point3d random() {
		return new Point3d(Math.random() * 400 + 50, Math.random() * 400 + 50, Math.random() * 400 + 50);
	}
	...
	private static Point3d[] parsePoints(String s) {
	...
	private static void print(Point3d[] points) {
