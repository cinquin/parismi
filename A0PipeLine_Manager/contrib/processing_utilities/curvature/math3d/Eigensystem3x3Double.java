...
class Eigensystem3x3Double {

	/* change */private double[][] m;

	/* change */double[] eigenVectors;
	/* change */private double[] eigenValues;
	...
	public boolean findEvalues() {
		...
		double d = +A * D * F - A * E * E - B * B * F + 2 * B * C * E - C * C * D;
		...
		if (discriminant > 0) {
			...
			eigenValues[0] = (sPlusT - bOver3A);
			eigenValues[1] = (-sPlusT / 2 - bOver3A);
