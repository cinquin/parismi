...
public class Edge {
	...
	private ArrayList<SkeletonPoint> slabs = null;
	/** length of the edge */
	 ...
	 */
	public Edge(Vertex v1, Vertex v2, ArrayList<SkeletonPoint> slabs, double length) {
		this.v1 = v1;
		this.v2 = v2;
		this.slabs = slabs;
		this.length = length;
	 ...
	 */
	public ArrayList<SkeletonPoint> getSlabs() {
		return this.slabs;
	}
