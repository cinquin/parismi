...
public class MedianIntensity_NO_0 extends RayFunction {
	 ...
	 * pixel.
	 */
	public MedianIntensity_NO_0(float[] fp, int num, float minPixelValueToConsider, float maxPixelValueToConsider) {
		// num is the number of slices
		fpixels = fp;
		len = fpixels.length;
		num_non_0 = new int[len * num];
