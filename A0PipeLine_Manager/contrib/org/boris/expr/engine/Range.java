...
public class Range implements Cloneable {
	...
	private Range(String namespace, String dim1Name, GridReference dim1, String dim2Name, GridReference dim2) {
		this.namespace = namespace;
	...
	public boolean equals(Object obj) {
		...
		if (!Reflect.equals(r.dim1, dim1))
			return false;
		return Reflect.equals(r.dim2, dim2);
	}
	...
	public static Range toRange(ExprArray array, GridReference offset) {
		...
		GridReference dim2 =
				new GridReference(offset.getColumn() + array.columns() - 1, offset.getRow() + array.rows() - 1);
	...
	public Range[] split() {
		...
		for (int i = 0; i < height; i++) {
			for (int j = 0; j < width; j++) {
				arr[i * width + j] = new Range(namespace, new GridReference(j + x1, i + y1));
			}
		}
		return arr;
	}
	...
	public Object clone() throws CloneNotSupportedException {
		return new Range(namespace == null ? null : new String(namespace), dim1Name == null ? null : new String(
				dim1Name), dim1 == null ? null : (GridReference) dim1.clone(), dim2Name == null ? null : new String(
				dim2Name), dim2 == null ? null : (GridReference) dim2.clone());
	}
}
