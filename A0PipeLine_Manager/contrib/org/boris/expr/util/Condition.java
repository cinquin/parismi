...
public class Condition {
	...
	public static Condition valueOf(Expr arg) {
		if (arg instanceof ExprString) {
			...
			operator.setRHS(Condition.getRHS(s, offset, str));
	...
	private static Expr getRHS(String text, int offset, boolean str) {
		if (str) {
	...
	public boolean eval(Expr arg) throws ExprException {
		if (operators.isEmpty()) {
			...
			ExprBoolean v = (ExprBoolean) func.evaluate(null, operators.toArray(new Expr[0]));
			return v.value;
		}
	}
