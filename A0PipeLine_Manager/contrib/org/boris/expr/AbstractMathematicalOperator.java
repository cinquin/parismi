...
public abstract class AbstractMathematicalOperator extends AbstractBinaryOperator {
	AbstractMathematicalOperator(ExprType type, Expr lhs, Expr rhs) {
		super(type, lhs, rhs);
	}

	double evaluateExpr(Expr e, IEvaluationContext context) throws ExprException {
		e = eval(e, context);
		if (e == null)
			return 0;
	...
	protected abstract Expr evaluate(double lhs, double rhs) throws ExprException;
}
