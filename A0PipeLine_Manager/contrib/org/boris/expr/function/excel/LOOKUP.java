...
public class LOOKUP extends AbstractFunction {
	...
	private static Expr vectorLookup(IEvaluationContext context, Expr[] args) throws ExprException {
	...
	private static Expr arrayLookup(IEvaluationContext context, Expr[] args) {
		return null;
	}
}
