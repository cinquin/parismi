...
public class AND extends AbstractFunction {
	...
	boolean eval(IEvaluationContext context, Expr a, boolean strict) throws ExprException {
		if (a == null)
			return true;
		...
		if (strict)
			throw new ExprException("Unexpected argument to " + getClass().getSimpleName() + ": " + a);
