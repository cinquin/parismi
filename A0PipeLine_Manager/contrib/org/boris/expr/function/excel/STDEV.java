...
public class STDEV extends AbstractFunction {
	...
	static Expr variance(IEvaluationContext context, Expr[] args, boolean allPopulation) throws ExprException {
	...
	static Expr stdev(IEvaluationContext context, Expr[] args, boolean allPopulation) throws ExprException {
	...
	private static void eval(IEvaluationContext context, Expr a, double average, double[] values, boolean strict)
