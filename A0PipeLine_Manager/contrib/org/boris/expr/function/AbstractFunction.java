...
public abstract class AbstractFunction implements IExprFunction {
	...
	protected void assertArgCount(Expr[] args, int count) throws ExprException {
		...
		if (args.length != count)
			throw new ExprException(getClass().getSimpleName() + " function takes " + count + " arguments");
	}

	protected void assertArgTypes(Expr[] args, ExprType... types) throws ExprException {
