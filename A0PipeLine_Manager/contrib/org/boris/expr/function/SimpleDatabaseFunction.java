...
public abstract class SimpleDatabaseFunction extends AbstractDatabaseFunction {
	@Override
	protected final Expr evaluate(IEvaluationContext context, Database db, String field, Criteria criteria)
	...
	protected abstract Expr evaluateMatches(IEvaluationContext context, Expr[] matches) throws ExprException;
}
