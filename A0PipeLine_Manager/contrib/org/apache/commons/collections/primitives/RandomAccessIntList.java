...
public abstract class RandomAccessIntList extends AbstractIntCollection implements IntList {
	...
	public boolean addAll(int index, IntCollection collection) {
		...
		for (IntIterator iter = collection.intIterator(); iter.hasNext();) {
			add(index++, iter.next());
			modified = true;
		}
		return modified;
	...
	public boolean equals(Object that) {
		if (this == that) {
			...
			for (IntIterator thatIter = thatList.intIterator(), thisIter = intIterator(); thisIter.hasNext();) {
	...
	private static class ComodChecker {
		...
		RandomAccessIntList getList() {
			return _source;
		}

		void assertNotComodified() throws ConcurrentModificationException {
