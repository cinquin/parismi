...
/**
 * Adapts an {@link ByteCollection ByteCollection} to the {@link java.util.Collection Collection} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link ByteCollection ByteCollection} implementation in
 * the "obvious" way.
 * 
...
final public class ByteCollectionCollection extends AbstractByteCollectionCollection implements Serializable {
	 ...
	 * 
	 * @param collection
	 *            the (possibly <code>null</code>) {@link ByteCollection ByteCollection} to wrap
