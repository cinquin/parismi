...
/**
 * Adapts an {@link DoubleIterator DoubleIterator} to the {@link java.util.Iterator Iterator} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link DoubleIterator DoubleIterator} implementation in
 * the "obvious" way.
 *
...
public class DoubleIteratorIterator implements Iterator {
	 ...
	 * 
	 * @param iterator
	 *            the (possibly <code>null</code>) {@link DoubleIterator DoubleIterator} to wrap
