...
/**
 * Adapts an {@link IntIterator IntIterator} to the {@link java.util.Iterator Iterator} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link IntIterator IntIterator} implementation in the
 * "obvious" way.
 *
...
public class IntIteratorIterator implements Iterator {
	 ...
	 * 
	 * @param iterator
	 *            the (possibly <code>null</code>) {@link IntIterator IntIterator} to wrap
