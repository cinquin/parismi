...
/**
 * Adapts an {@link CharIterator CharIterator} to the {@link java.util.Iterator Iterator} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link CharIterator CharIterator} implementation in the
 * "obvious" way.
 *
...
public class CharIteratorIterator implements Iterator {
	 ...
	 * 
	 * @param iterator
	 *            the (possibly <code>null</code>) {@link CharIterator CharIterator} to wrap
