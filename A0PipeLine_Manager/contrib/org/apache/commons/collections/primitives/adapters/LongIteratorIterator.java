...
/**
 * Adapts an {@link LongIterator LongIterator} to the {@link java.util.Iterator Iterator} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link LongIterator LongIterator} implementation in the
 * "obvious" way.
 *
...
public class LongIteratorIterator implements Iterator {
	 ...
	 * 
	 * @param iterator
	 *            the (possibly <code>null</code>) {@link LongIterator LongIterator} to wrap
