...
/**
 * Adapts an {@link DoubleCollection DoubleCollection} to the {@link java.util.Collection Collection} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link DoubleCollection DoubleCollection} implementation
 * in the "obvious" way.
 * 
...
final public class DoubleCollectionCollection extends AbstractDoubleCollectionCollection implements Serializable {
	 ...
	 * 
	 * @param collection
	 *            the (possibly <code>null</code>) {@link DoubleCollection DoubleCollection} to wrap
