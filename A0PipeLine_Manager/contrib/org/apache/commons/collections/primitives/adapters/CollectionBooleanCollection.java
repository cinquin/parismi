 ...
 * Collection} to the {@link org.apache.commons.collections.primitives.BooleanCollection
 * BooleanCollection} interface.
 * <p/>
 * This implementation delegates most methods to the provided {@link java.util.Collection Collection} implementation in
 * the "obvious" way.
 * 
...
final public class CollectionBooleanCollection extends AbstractCollectionBooleanCollection implements Serializable {
	...
	/**
	 * Create an {@link org.apache.commons.collections.primitives.BooleanCollection
	 ...
	 * 
	 * @param collection
	 *            the (possibly <code>null</code>) {@link java.util.Collection} to wrap
	 * @return an {@link org.apache.commons.collections.primitives.BooleanCollection
	...
	/**
	 * Creates an {@link org.apache.commons.collections.primitives.BooleanCollection
	 * BooleanCollection} wrapping the specified {@link java.util.Collection
	 * Collection}.
	 * 
	 * @see #wrap
