...
/**
 * Adapts a {@link Boolean Boolean}-valued {@link java.util.Iterator Iterator} to the
 * {@link org.apache.commons.collections.primitives.BooleanIterator
 * BooleanIterator} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link java.util.Iterator Iterator} implementation in the
 * "obvious" way.
 *
...
public class IteratorBooleanIterator implements BooleanIterator {
	 ...
	 * Iterator}. When the given <i>iterator</i> is <code>null</code>, returns <code>null</code>.
	 * 
	 * @param iterator
	 *            the (possibly <code>null</code>) {@link java.util.Iterator Iterator} to wrap
	 * @return an {@link org.apache.commons.collections.primitives.BooleanIterator BooleanIterator} wrapping the given
	 *         <i>iterator</i>, or <code>null</code> when <i>
