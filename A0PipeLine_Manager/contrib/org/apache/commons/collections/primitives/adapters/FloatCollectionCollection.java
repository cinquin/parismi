...
/**
 * Adapts an {@link FloatCollection FloatCollection} to the {@link java.util.Collection Collection} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link FloatCollection FloatCollection} implementation in
 * the "obvious" way.
 * 
...
final public class FloatCollectionCollection extends AbstractFloatCollectionCollection implements Serializable {
	 ...
	 * 
	 * @param collection
	 *            the (possibly <code>null</code>) {@link FloatCollection FloatCollection} to wrap
