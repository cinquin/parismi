...
/**
 * Adapts an {@link ShortIterator ShortIterator} to the {@link java.util.Iterator Iterator} interface.
 * <p />
 * This implementation delegates most methods to the provided {@link ShortIterator ShortIterator} implementation in the
 * "obvious" way.
 *
...
public class ShortIteratorIterator implements Iterator {
	 ...
	 * 
	 * @param iterator
	 *            the (possibly <code>null</code>) {@link ShortIterator ShortIterator} to wrap
