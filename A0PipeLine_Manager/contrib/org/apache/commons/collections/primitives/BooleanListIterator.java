...
public interface BooleanListIterator extends BooleanIterator {
	 ...
	 * in the reverse direction. (In other words, returns <code>true</code> iff a call to {@link #previous} will return
	...
	/**
	 * Returns the index of the element that would be returned
	 * by a subsequent call to {@link #previous}, or <code>-1</code> if I have no previous element.
	 * 
	 ...
	 * element returned by {@link #next} or {@link #previous} (optional operation).
	 * 
	 * @throws UnsupportedOperationException
	 *             if this operation is not
	 *             supported
	 * @throws IllegalStateException
	 *             if neither {@link #next} nor {@link #previous} has yet been called, or {@link #remove} or
	 *             {@link #add} has already been called since
	 ...
	 * element returned by {@link #next} or {@link #previous} with the specified value (optional operation).
	 * 
	 * @param element
