 ...
 * in the range [{@link #MIN_VALUE}, {@link #MAX_VALUE}] in 8-bits
...
public class ArrayUnsignedByteList extends RandomAccessShortList implements ShortList, Serializable {
	 ...
	 */
	private ArrayUnsignedByteList(int initialCapacity) {
	...
	private static byte fromShort(short value) {
		return (byte) (value & MAX_VALUE);
	}

	private static void assertValidUnsignedByte(short value) throws IllegalArgumentException {
		if (value > MAX_VALUE) {
