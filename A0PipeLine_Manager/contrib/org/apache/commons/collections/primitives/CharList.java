...
public interface CharList extends CharCollection {
	 ...
	 * and for which the elements returned by its {@link CharList#iterator iterator} are equal (<code>==</code>) to
	 ...
	 * call to the {@link CharListIterator#next next} method. An initial call to the {@link CharListIterator#previous
	 ...
	 * <i>toIndex</i>, exclusive. The returned <code>CharList</code> is backed by me, so that any changes in
