...
public interface IntList extends IntCollection {
	 ...
	 * collection's {@link IntCollection#intIterator iterator}.
	 * 
	 * @param index
	 ...
	 * and for which the elements returned by its {@link IntList#intIterator iterator} are equal (<code>==</code>) to
	 ...
	 * call to the {@link IntListIterator#next next} method. An initial call to the {@link IntListIterator#previous
	 ...
	 * <i>toIndex</i>, exclusive. The returned <code>IntList</code> is backed by me, so that any changes in
