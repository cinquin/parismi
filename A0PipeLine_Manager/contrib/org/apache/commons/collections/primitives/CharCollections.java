...
final class CharCollections {
	 ...
	 */
	private static CharList singletonCharList(char value) {
	 ...
	 */
	private static CharList unmodifiableCharList(CharList list) throws NullPointerException {
		if (null == list) {
	 ...
	 */
	private static CharIterator unmodifiableCharIterator(CharIterator iter) {
		if (null == iter) {
			throw new NullPointerException();
		}
	 ...
	 */
	private static CharListIterator unmodifiableCharListIterator(CharListIterator iter) {
		if (null == iter) {
			throw new NullPointerException();
		}
	 ...
	 */
	private static final CharList EMPTY_CHAR_LIST = unmodifiableCharList(new ArrayCharList(0));
	 ...
	 */
	private static final CharIterator EMPTY_CHAR_ITERATOR = unmodifiableCharIterator(EMPTY_CHAR_LIST.iterator());
	 ...
	 */
	private static final CharListIterator EMPTY_CHAR_LIST_ITERATOR = unmodifiableCharListIterator(EMPTY_CHAR_LIST
			.listIterator());
}
