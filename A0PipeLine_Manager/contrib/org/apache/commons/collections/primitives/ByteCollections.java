...
final class ByteCollections {
	 ...
	 */
	private static ByteList singletonByteList(byte value) {
	 ...
	 */
	private static ByteList unmodifiableByteList(ByteList list) throws NullPointerException {
		if (null == list) {
	 ...
	 */
	private static ByteIterator unmodifiableByteIterator(ByteIterator iter) {
		if (null == iter) {
			throw new NullPointerException();
		}
	 ...
	 */
	private static ByteListIterator unmodifiableByteListIterator(ByteListIterator iter) {
		if (null == iter) {
			throw new NullPointerException();
		}
	 ...
	 */
	private static final ByteList EMPTY_BYTE_LIST = unmodifiableByteList(new ArrayByteList(0));
	 ...
	 */
	private static final ByteIterator EMPTY_BYTE_ITERATOR = unmodifiableByteIterator(EMPTY_BYTE_LIST.iterator());
	 ...
	 */
	private static final ByteListIterator EMPTY_BYTE_LIST_ITERATOR = unmodifiableByteListIterator(EMPTY_BYTE_LIST
			.listIterator());
}
