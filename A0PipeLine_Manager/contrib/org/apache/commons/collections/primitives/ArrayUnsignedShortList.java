...
public class ArrayUnsignedShortList extends RandomAccessIntList implements IntList, Serializable {
	 ...
	 */
	private ArrayUnsignedShortList(int initialCapacity) {
	...
	private static short fromInt(int value) {
		return (short) (value & MAX_VALUE);
	}

	private static void assertValidUnsignedShort(int value) throws IllegalArgumentException {
		if (value > MAX_VALUE) {
