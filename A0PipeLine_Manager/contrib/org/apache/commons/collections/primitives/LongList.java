...
public interface LongList extends LongCollection {
	 ...
	 * and for which the elements returned by its {@link LongList#iterator iterator} are equal (<code>==</code>) to
	 ...
	 * call to the {@link LongListIterator#next next} method. An initial call to the {@link LongListIterator#previous
	 ...
	 * <i>toIndex</i>, exclusive. The returned <code>LongList</code> is backed by me, so that any changes in
