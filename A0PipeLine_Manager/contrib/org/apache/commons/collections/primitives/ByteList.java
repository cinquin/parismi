...
public interface ByteList extends ByteCollection {
	 ...
	 * and for which the elements returned by its {@link ByteList#iterator iterator} are equal (<code>==</code>) to
	 ...
	 * call to the {@link ByteListIterator#next next} method. An initial call to the {@link ByteListIterator#previous
	 ...
	 * <i>toIndex</i>, exclusive. The returned <code>ByteList</code> is backed by me, so that any changes in
