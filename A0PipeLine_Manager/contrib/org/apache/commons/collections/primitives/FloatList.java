...
public interface FloatList extends FloatCollection {
	 ...
	 * (optional operation). Returns <code>true</code> iff I changed as a result of this call.
	 * <p/>
	...
	/**
	 * Returns <code>true</code> iff <i>that</i> is an <code>FloatList</code> that contains the same elements in the
	 * same order as me.
	 * In other words, returns <code>true</code> iff <i>that</i> is
	 * a <code>FloatList</code> that has the same {@link #size() size} as me,
	 * and for which the elements returned by its {@link FloatList#iterator iterator} are equal (<code>==</code>) to
	 ...
	 * @return <code>true</code> iff <i>that</i> is an <code>FloatList</code> that contains the same elements in the
	 *         same order as me
	 */
	@Override
	 ...
	 * call to the {@link FloatListIterator#next next} method. An initial call to the {@link FloatListIterator#previous
	 ...
	 * <i>toIndex</i>, exclusive. The returned <code>FloatList</code> is backed by me, so that any changes in
