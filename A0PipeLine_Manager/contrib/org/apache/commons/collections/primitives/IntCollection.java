...
public interface IntCollection {
	 ...
	 *         specified elements, in other words, returns <code>true</code> iff I changed as a result of this call
	 * 
	 * @throws UnsupportedOperationException
	 *             when this operation is not
	 *             supported
	 ...
	 * <p/>
	 * The returned array will be independent of me, so that callers may modify that returned array without modifying
	 * this collection.
	 * <p/>
	 * When I guarantee the order in which elements are returned by an {@link #intIterator iterator}, the returned array
	 * will contain elements in the same order.
	 * 
