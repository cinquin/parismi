...
final class ShortCollections {
	 ...
	 */
	private static ShortList singletonShortList(short value) {
	 ...
	 */
	private static ShortList unmodifiableShortList(ShortList list) throws NullPointerException {
		if (null == list) {
	 ...
	 */
	private static ShortIterator unmodifiableShortIterator(ShortIterator iter) {
		if (null == iter) {
			throw new NullPointerException();
		}
	 ...
	 */
	private static ShortListIterator unmodifiableShortListIterator(ShortListIterator iter) {
		if (null == iter) {
			throw new NullPointerException();
		}
	 ...
	 */
	private static final ShortList EMPTY_SHORT_LIST = unmodifiableShortList(new ArrayShortList(0));
	 ...
	 */
	private static final ShortIterator EMPTY_SHORT_ITERATOR = unmodifiableShortIterator(EMPTY_SHORT_LIST.iterator());
	 ...
	 */
	private static final ShortListIterator EMPTY_SHORT_LIST_ITERATOR = unmodifiableShortListIterator(EMPTY_SHORT_LIST
			.listIterator());
}
