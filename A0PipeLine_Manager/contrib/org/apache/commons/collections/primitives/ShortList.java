...
public interface ShortList extends ShortCollection {
	...
	/**
	 * Returns <code>true</code> iff <i>that</i> is an <code>ShortList</code> that contains the same elements in the
	 * same order as me.
	 * In other words, returns <code>true</code> iff <i>that</i> is
	 * a <code>ShortList</code> that has the same {@link #size() size} as me,
	 * and for which the elements returned by its {@link ShortList#iterator iterator} are equal (<code>==</code>) to
	 ...
	 * @return <code>true</code> iff <i>that</i> is an <code>ShortList</code> that contains the same elements in the
	 *         same order as me
	 */
	@Override
	 ...
	 * call to the {@link ShortListIterator#next next} method. An initial call to the {@link ShortListIterator#previous
	 ...
	 * <i>toIndex</i>, exclusive. The returned <code>ShortList</code> is backed by me, so that any changes in
