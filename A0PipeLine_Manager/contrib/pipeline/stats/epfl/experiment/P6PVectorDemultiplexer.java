...
/**
 * A double vector demultiplexer for problem P6 with prior probabilities
 *
 * @author Camille Weber <camille.weber@epfl.ch>
 */
public class P6PVectorDemultiplexer extends VectorDemultiplexer2 {
	 ...
	 */
	public P6PVectorDemultiplexer(VectorReader in) {
		super(in, 3);
		this.nFeatures = in.size() - 3;
		outResized = new VectorReaderPImpl[3];
		outResized[0] = new VectorReaderPImpl(super.getVectorReader(0), 3, 0);
		outResized[1] = new VectorReaderPImpl(super.getVectorReader(1), 3, 1);
		outResized[2] = new VectorReaderPImpl(super.getVectorReader(2), 3, 2);
	}
