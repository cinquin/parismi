 ...
 * Description:   Finds the eigenvalues (d) and eigenvectors (V) of a symmetric matrix. n is the    *
 *                dimension of the matrix.  I have defined n=3.  I think that the eigenvalues are   *
