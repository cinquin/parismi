...
public class ImageCanvas extends Canvas implements MouseListener, MouseMotionListener, Cloneable {
	...
	private int sx2, sy2;
	private boolean disablePopupMenu=true;
    ...
    public void paint(Graphics g) {
		Roi roi = imp.getRoi();
		if (true || roi!=null || showAllROIs || overlay!=null) {
			if (roi!=null) roi.updatePaste();
			if (imageWidth!=0) {//!IJ.isMacOSX() &&
    ...
    protected void drawAllROIs(Graphics g) {
    ...
    */
	...
	public void mousePressed(MouseEvent e) {
		...
		if (toolID==Toolbar.HAND){
			//OC Dec. 2010: do this before the null test below; if not dragging does not work
				setupScroll(ox, oy);
				return;
		}
