...
public class ScrollbarWithLabel extends Panel implements Adjustable, AdjustmentListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4222816621592648622L;
	Scrollbar bar;
	private Icon icon;
	...
	public void setFocusable(final boolean focusable) {
		Runnable r=new Runnable(){
			@Override
			public void run(){
				ScrollbarWithLabel.super.setFocusable(focusable);
	...
	class Icon extends Canvas implements MouseListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 950210099520855279L;
