...
public class IJ {
	...
	static Object runUserPlugIn(String commandName, String className, String arg, boolean createNewLoader) {
		...
		Object thePlugIn = null;
		//loader.loadClass("com.thoughtworks.xstream.converters.reflection.ReflectionProvider")arg.
		try { 
	...
	public static void runNoInit(String command, String options) {
		//IJ.log("run1: "+command+" "+Thread.currentThread().hashCode());
		//if (ij==null && Menus.getCommands()==null)
		//	init();
		Macro.abort = false;
	...
	*/
	...
	public static void setMacroRunning(boolean running) {
